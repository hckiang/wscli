...
- usocket – TCP sockets.
- cl+ssl – SSL/TLS for secure connections.
- ironclad – cryptographic randomness and SHA‑1.
- cl-base64 – Base64 encoding.
- babel – UTF‑8 encoding/decoding.
- bordeaux‑threads – locks and condition variables.
- quri – URL parsing.
